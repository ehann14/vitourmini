...
<body>
                ...
                <nav class="navbar-admin">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="d-flex align-items-center gap-2 gap-md-3">
                            ...
                            <h4 class="mb-0 fw-bold d-none d-sm-block" style="color: var(--heading-color); font-size: 1.15rem;"><i class="fas fa-plus-circle me-2"></i>Tambah Panorama Baru</h4>
                            <h5 class="mb-0 fw-bold d-sm-none" style="color: var(--heading-color);"><i class="fas fa-plus-circle me-1"></i>Tambah</h5>
                        </div>
                        ...
                        <form method="POST" action="{{ route('admin.panorama.store') }}" enctype="multipart/form-data" id="panoramaForm">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-text">Huruf kecil, tanpa spasi. Digunakan sebagai link antar panorama.</div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="form-text">Pilih "Gambar Normal" untuk foto biasa (bukan 360°)</div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="form-text">Format: JPG, PNG, WebP. <strong>Maksimal 10 MB.</strong></div>
                                    <div id="fileSizeError" class="file-size-error"><i class="fas fa-exclamation-triangle me-1"></i>Ukuran file melebihi 10 MB!</div>
                                </div>

                                <div class="col-12">
                                    <label class="form-label d-flex align-items-center gap-2"><i class="fas fa-map-marked-alt" style="color: var(--accent-teal)"></i> Hotspots Interaktif <span class="badge-hotspot" id="hotspotCount">0 item</span></label>
                                    <div class="form-text d-block mb-2"><strong>Klik langsung di gambar</strong> untuk menambah hotspot. Hover pin untuk menghapus.</div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-text"><a href="https://fontawesome.com/icons" target="_blank" style="color: var(--accent-teal)">Lihat semua icon</a></div>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="d-flex flex-wrap gap-3 mt-4 pt-3 border-top" style="border-color: var(--border-color) !important;">
                                <button type="submit" class="btn-primary-custom" id="submitBtn"><i class="fas fa-save"></i>Simpan Panorama</button>
    ...
    function formatFileSize(bytes) { const k = 1024, sizes = ['Bytes','KB','MB','GB']; const i = Math.floor(Math.log(bytes) / Math.log(k)); return parseFloat((bytes / Math.pow(k, i)).toFixed(2)) + ' ' + sizes[i]; }
    ...
    document.getElementById('panoramaForm').addEventListener('submit', function(e) { const file = document.getElementById('image_path').files[0]; if (file && file.size > 10485760) { e.preventDefault(); alert('Ukuran file gambar melebihi 10 MB.'); } });
